...
namespace RefillingStation.Api.Controllers
{
    ...
    public class ImportPayrollsController : ControllerBase
    {
        private readonly IPayrollImportService _service;

        public ImportPayrollsController(IPayrollImportService service)
        {
            _service = service;
        }
